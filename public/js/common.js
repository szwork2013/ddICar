...
var highline={
	...
	,animation_:function(num){
		switch(num){
			...
			setTimeout(function(){ $("#videopar .left").addClass("add"); },time);
			setTimeout(function(){ $("#videopar .right").addClass("add"); },time);
			break;
			case 2:
			var time=400,time1=600;
			$(".cont2_wrap").addClass("add");
			setTimeout(function(){ $(".cont2_img1").addClass("add"); },time);
			setTimeout(function(){ $(".cont2_img2").addClass("add"); },time1);
			setTimeout(function(){ $(".cont2_img3").addClass("add"); },time1);	
			break;
			case 3:
			var time=400,time1=800;
			$(".cont3_img1").addClass("add");
			setTimeout(function(){ $(".cont3_img2").addClass("add"); },time);
			setTimeout(function(){ $(".cont3_img3 img").addClass("add"); },time1);
			break;	
			case 4:
			var time=400;
			$(".cont4_img1").addClass("add");
			$(".cont4_img2").addClass("add");
			setTimeout(function(){ $(".cont4_img3").addClass("add"); },time);
			break;	
			case 5:
			var time=400;
			$(".cont5_img1").addClass("add");
			setTimeout(function(){ $(".cont5_img2").addClass("add"); },time);
			break;
		}				
	}
	,animationBack:function(num){
		switch(num){
			case 1:
				var time = 400;
				$("#videopar .left").removeClass("add");
				$("#videopar .right").removeClass("add");
				setTimeout(function(){ $("#videopar").removeClass("videopar_ani"); },time);	
			break;
			case 2:
			var time=400,time1=200;
			$(".cont2_img3").removeClass("add");
			$(".cont2_img2").removeClass("add");
			setTimeout(function(){ $(".cont2_img1").removeClass("add"); },time1);
			setTimeout(function(){ $(".cont2_wrap").removeClass("add"); },time);		
			break;
			case 3:
			var time=400,time1=200;
			$(".cont3_img3 img").removeClass("add");
			setTimeout(function(){ $(".cont3_img2").removeClass("add"); },time1);
			setTimeout(function(){ $(".cont3_img1").removeClass("add"); },time);
			break;	
			case 4:
			var time=400;
			$(".cont4_img3").removeClass("add");
			setTimeout(function(){ $(".cont4_img2").removeClass("add"); },time);
			setTimeout(function(){ $(".cont4_img1").removeClass("add"); },time);
			break;	
			case 5:
			$(".cont5_img2").removeClass("add");
			setTimeout(function(){ $(".cont5_img1").removeClass("add"); },time);
			break;
		}						
	}
